...
export const NOTABLE_HOTELS = [
  {
    ...
    state: "FL",
    citySlug: "miami",
    description: "Alan Faena's maximalist monument to another era — the pool runs at garden level between the hotel and the sand, with direct beach access, flanked by candy-striped cabanas that are gloriously over the top. Not a rooftop, but one of the most theatrical pools in the country.",
  ...
  // swimmable again. Affiliate entry retained in src/data/affiliates.js.
  {
    ...
    state: "TX",
    citySlug: "austin",
    description: "The pool sits at the water's edge on Lady Bird Lake with downtown Austin's skyline cresting above the treeline — a heated lakeside infinity pool, not a rooftop one, looking straight out at the Congress Avenue Bridge and the bats that pour off it at dusk. Day passes available.",
