  ...
  "miami": {
    ...
    "hotels": [
      ...
      },
      {
        ...
        "description": "A preserved 1930s Art Deco building on Collins with a rooftop pool that looks out over the district on one side and the Atlantic on the other. Day passes start at $25, which makes it the most accessible rooftop swim on this list by a distance — though at a marked 3 ft 6 in it is a pool for standing in, not swimming laps.",
        "poolNote": "Rooftop pool · Marked 3 ft 6 in throughout · Atlantic + Art Deco district views · Day passes from $25 · Cabanas from $150",
        "tags": [
          "Rooftop",
          "Oceanfront",
          "Day Pass",
