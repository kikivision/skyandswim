...
export const BEYOND_HOTELS = [
  {
    ...
    metroOf: "miami",
    description: "The Sky Deck pool sits above the beachfront tower with the Atlantic filling the whole view — heated, cabana-lined, full towel-and-bar service, and day passes for anyone not staying. Fort Lauderdale's most-cited hotel pool, and it earns the billing.",
  ...
  },
  {
    ...
    city: "Savannah",
    state: "GA",
    description: "Savannah's swankiest rooftop — a tropical-leaning pool deck beside the Peregrin bar with a panorama over the Historic District's rooftops and steeples. It runs year-round, heated through the cooler months, and the poolside service is the part regulars won't stop mentioning.",
  ...
  },
  {
    ...
    city: "Atlanta",
    state: "GA",
    description: "Not downtown — out at The Battery, where the 5th-floor pool deck overlooks the entertainment district wrapped around Truist Park. Cabanas line it and the pool bar runs seasonally. Day passes make it one of the easier good decks in Atlanta to get onto without a room.",
  ...
  },
  {
    ...
    city: "San Antonio",
    state: "TX",
    description: "The Cenote pool deck juts off the 4th floor of the 20-story tower with an unobstructed sweep of the San Antonio skyline, cabanas along the edge — and Moon's Daughters, sixteen floors above it at the top of the building, when you're done swimming. Guests and residents only.",
  ...
  },
  {
    ...
    city: "Louisville",
    state: "KY",
    description: "Downtown Louisville's marquee stay, and its heated third-floor pool deck with a rooftop bar is the city's most-cited — a clean skyline swim in a town where rooftop pools are otherwise thin. Seasonal, reopening each Memorial Day.",
  ...
  },
  {
    ...
    city: "Tucson",
    state: "AZ",
    description: "A straightforward heated rooftop pool in a city that has very few — no grand claims from the operator, and none from us. It is open early to late, it is on the roof, it is for guests, and in Tucson that is enough to be worth knowing about.",
